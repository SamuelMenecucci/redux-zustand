import { MessageCircle, ChevronDown, Video } from "lucide-react"; //lib de ícones https://lucide.dev/guide/packages/lucide-react

import ReactPlayer from "react-player"; //lib que permite que eu facá embed de vídeos de vários sources (providers). https://www.npmjs.com/package/react-player
